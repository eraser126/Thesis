...
% Keep floats close to the surrounding discussion.
% The defaults are conservative and can push consecutive tables/algorithms
% onto float-only pages even when there is enough useful text nearby.
